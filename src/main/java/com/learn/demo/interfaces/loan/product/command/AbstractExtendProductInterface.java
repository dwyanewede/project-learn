 ...
 * @Description: 抽象类实现 ProductInterface，可扩展基础功能服务，类似于短信发送等 {@link ExtendProductInterface}
 * @Author: 尚先生
 * @CreateDate: 2019/5/10 11:30
 * @Version: 1.0
 */
public abstract class AbstractExtendProductInterface implements ExtendProductInterface {

    // 扩展短信发送服务功能
    public boolean sendMsg(Map<String,Object> smsMap){
        System.out.println("从 AbstractExtendProductInterface smsMap 中取出对应参数，发送短信");
        // TODO rpc 调用短信发送服务接口
        return true;
    }
